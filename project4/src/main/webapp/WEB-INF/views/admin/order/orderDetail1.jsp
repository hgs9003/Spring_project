    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <table class="table table-bordered">
        	...
        	<c:forEach items="${odList1 }" var="orderDetailVOList">
        	<tr>
        		<td>
        		<img src="/admin/order/displayFile?folderName=${orderDetailVOList.pdt_img_folder }&fileName=s_${orderDetailVOList.pdt_img }" 
	      		alt="" style="width: 50px;height: 50px;" onerror="this.onerror=null; this.src='/image/no_images.png'">
	      	<a class="move" href="${orderDetailVOList.pdt_num }"><c:out value="${orderDetailVOList.pdt_name }" escapeXml="true" /></a>
        		<br>
        		${orderDetailVOList.odr_code }
        		</td>
        		<td>${orderDetailVOList.odr_amount }</td>
        		<td><span class="odr_price">${orderDetailVOList.odr_price }</span></td>
        		<td>0원</td>
        		<td>
					<input type="hidden" name="odr_code" value="${orderDetailVOList.odr_code }">
					<input type="hidden" name="pdt_num" value="${orderDetailVOList.pdt_num }">
